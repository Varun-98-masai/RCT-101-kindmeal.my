    ...
    return (
      <Box className='footer' 
        ...
        <Container as={Stack} maxW={'6xl'} py={10}>
          <SimpleGrid columns={{ base: 1, sm: 2, md: 5  }} spacing={8} fontSize={12} textAlign={"left"}>
        ...
        <Box py={10}>
          ...
          <Text pt={6} fontSize={10} textAlign={'center'} alignItems={'center'} justifyContent={'center'}>
